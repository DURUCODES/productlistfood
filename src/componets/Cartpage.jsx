...
const Cartpage = () => {
  const totalQuantity = useSelector((state) => state.order.food);

  return (
    <div className="mt-4 md:mt-0 shadow-xl w-96 bg-white rounded-xl md:px-6 md:py-4 px-6 py-4 flex flex-col">
      <div className="text-xl font-bold px-14 text-red-700">
        {/* Optional title can go here */}
      </div>
      {totalQuantity.length > 0 ? (
        <div>
          <h3 className="text-red-700 text-2xl font-bold">
            Your Cart ({totalQuantity.length})
          </h3>
          <div>
            <ItemsList />
          </div>
        ...
        <div className="">
          <h3 className="text-red-700 font-bold text-xl">Your Cart (0)</h3>
          <div className="flex px-11 flex-col items-center text-center">
            <span>
              <svg
            ...
            <p className="lastp">Your added items will appear here</p>
          </div>
        </div>
      )}
    </div>
